abstract class LoginCubitState<T> {
...
class LoginInitial<T> extends LoginCubitState<T> {
  const LoginInitial();
  ...
  @override
  String toString() => 'LoginCubitState.initial()';
...
class LoginLoading<T> extends LoginCubitState<T> {
  const LoginLoading();
  ...
  @override
  String toString() => 'LoginCubitState.loading()';
...
class LoginSuccess<T> extends LoginCubitState<T> {
  final T data;
  ...
  @override
  String toString() => 'LoginCubitState.success(data: $data)';
...
class LoginError<T> extends LoginCubitState<T> {
  ...
  @override
  String toString() => 'LoginCubitState.error(error: $errorMessage)';
